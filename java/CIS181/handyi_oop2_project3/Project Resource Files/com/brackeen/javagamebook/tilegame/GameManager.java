...
public class GameManager extends GameCore {
    ...
    private GameAction gravityToggle;
    ...
    */
    ...
    private void initInput() {
        ...
        pause = new GameAction("pause",
        		GameAction.DETECT_INITAL_PRESS_ONLY);
        gravityToggle = new GameAction("gravityToggle",
        		GameAction.DETECT_INITAL_PRESS_ONLY);
        ...
        inputManager.mapToKey(gravityToggle, KeyEvent.VK_G);
    }
    ...
    public void checkInput(long elapsedTime) {
        ...
        if(gravityToggle.isPressed()){
        	gravityMultiplier = -gravityMultiplier;
        	Player.playerJumpSpeedMultiplier = -Player.playerJumpSpeedMultiplier;
        }
